# copied from reinforcement_learning/ext_libs/ext_libs.cmake
add_subdirectory(${CMAKE_CURRENT_LIST_DIR}/reinforcement_learning/ext_libs/fakeit)
add_subdirectory(${CMAKE_CURRENT_LIST_DIR}/reinforcement_learning/ext_libs/date)

if(RL_BUILD_PYTHON)
  add_subdirectory(${CMAKE_CURRENT_LIST_DIR}/reinforcement_learning/ext_libs/pybind11)
endif()
...
add_subdirectory(${CMAKE_CURRENT_LIST_DIR}/reinforcement_learning/ext_libs/vowpal_wabbit ${RL_ext_libs_exclude_from_all})
...
if(RL_USE_ZSTD)
  ...
  add_subdirectory(${CMAKE_CURRENT_LIST_DIR}/reinforcement_learning/ext_libs/zstd/build/cmake ${RL_ext_libs_exclude_from_all})
...
if(vw_USE_AZURE_FACTORIES)
  if(RL_OPENSSL_SYS_DEP)
    ...
    set(RL_OPENSSL_SOURCE_DIR "${CMAKE_CURRENT_LIST_DIR}/reinforcement_learning/ext_libs/openssl")
  ...
  if(RL_CPPRESTSDK_SYS_DEP)
    ...
    add_subdirectory(${CMAKE_CURRENT_LIST_DIR}/reinforcement_learning/ext_libs/cpprestsdk ${RL_ext_libs_exclude_from_all})
...
if(NOT TARGET string_view_lite)
  add_subdirectory(${CMAKE_CURRENT_LIST_DIR}/reinforcement_learning/ext_libs/string-view-lite)
endif()